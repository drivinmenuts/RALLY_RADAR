...
export const KNOWN_VENUES = [
  ...
  // New venues from Crawfords v2 run that failed geocoding:
  { match: /detectormania/i,                                           lat: 54.892, lon: -2.933, location: 'Carlisle, Cumbria' },
  { match: /celtic heritage.*summer|celtic heritage/i,                 lat: 51.481, lon: -3.179, location: 'South Wales (Celtic Heritage Rally)' },
  { match: /norfolk metal detecting tours/i,                           lat: 52.628, lon: 1.299,  location: 'Norfolk' },
  { match: /ifind|sons of archaeology|the big dig/i,                   lat: 52.270, lon: -0.886, location: 'Northamptonshire (Big Dig)' },
  { match: /hinton on the green/i,                                     lat: 52.075, lon: -1.989, location: 'Hinton on the Green, Worcestershire' },
  { match: /melchbourne|ses melchbourne/i,                             lat: 52.232, lon: -0.448, location: 'Melchbourne, Bedfordshire' },
  { match: /muddy boots/i,                                             lat: 52.500, lon: -1.500, location: 'Midlands (Muddy Boots)' },
  { match: /east durham detectors|hayton village/i,                    lat: 54.892, lon: -2.933, location: 'Brampton & Carlisle area, Cumbria' },
  { match: /northrepps/i,                                              lat: 52.913, lon: 1.323,  location: 'Northrepps Aerodrome, Norfolk' },
  { match: /dunmow rotary|dunmow.*rally/i,                             lat: 51.871, lon: 0.380,  location: 'Great Dunmow, Essex' },
  { match: /east of england rallies|euston weekend/i,                  lat: 52.380, lon: 0.797,  location: 'Euston Estate, Suffolk/Norfolk border' },
  { match: /dragon detecting/i,                                        lat: 52.250, lon: -3.500, location: 'Mid Wales (Dragon Detecting)' },
  { match: /digging history/i,                                         lat: 52.500, lon: -1.500, location: 'Midlands (Digging History UK)' }
];
